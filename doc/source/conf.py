...
project = 'scikit-gym'
copyright = '2018, Kristian Holsheimer'
...
htmlhelp_basename = 'scikit-gymdoc'
...
latex_documents = [
    (master_doc, 'scikit-gym.tex', 'scikit-gym Documentation',
...
man_pages = [
    (master_doc, 'scikit-gym', 'scikit-gym Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'scikit-gym', 'scikit-gym Documentation',
     author, 'scikit-gym', 'One line description of project.',
     'Miscellaneous'),
]
