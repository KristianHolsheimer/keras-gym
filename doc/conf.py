...
htmlhelp_basename = 'keras-gymdoc'
...
latex_documents = [
    (master_doc, 'keras-gym.tex', 'keras-gym Documentation',
...
man_pages = [
    (master_doc, 'keras-gym', 'keras-gym Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'keras-gym', 'keras-gym Documentation',
     author, 'keras-gym', 'One line description of project.',
     'Miscellaneous'),
]
